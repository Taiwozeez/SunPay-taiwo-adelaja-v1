  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 space-y-8">
      ...
      <div className="text-center max-w-2xl mx-auto">
        <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-amber-400 to-orange-400 rounded-2xl mb-4 shadow-lg">
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2">
            <path d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198l.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0A5.995 5.995 0 0 0 12 12.75a5.995 5.995 0 0 0-5.058 2.772m0 0a3 3 0 0 0-4.681 2.72 8.986 8.986 0 0 0 3.74.477m.94-3.197a5.971 5.971 0 0 0-.94 3.197M15 6.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0zm6 3a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0zm-13.5 0a2.25 2.25 0 1 1-4.5 0 2.25 2.25 0 0 1 4.5 0z" />
          </svg>
        </div>
        <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mb-2">How Can We Help You?</h1>
        <p className="text-gray-500">Our support team is here to assist you with any questions or issues.</p>
      </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 p-6">
            ...
            <div className="space-y-3">
              {[
                ...
                <button
                  key={index}
                  className="w-full text-left px-4 py-3 bg-gray-50 hover:bg-amber-50 rounded-xl text-sm text-gray-700 hover:text-amber-700 transition-all flex items-center justify-between group"
                >
                  {question}
                  <svg
                    width="16"
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-6 text-white">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center py-2 border-b border-gray-700">
                ...
                <span className="text-amber-400 font-medium">8:00 AM - 6:00 PM</span>
              </div>
              <div className="flex justify-between items-center py-2 border-b border-gray-700">
                <span className="text-gray-300">Saturday</span>
                <span className="text-amber-400 font-medium">9:00 AM - 4:00 PM</span>
              </div>
