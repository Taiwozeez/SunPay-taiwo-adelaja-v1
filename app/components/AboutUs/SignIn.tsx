      ...
      >
        ...
        <div className="w-full h-full flex items-center justify-center relative z-10">
          <div className="max-w-md text-center text-white px-8">
            <div className="w-64 h-64 bg-white/10 rounded-full flex items-center justify-center mx-auto mb-8 backdrop-blur-sm border border-white/20">
              <svg 
            ...
            <p className="text-lg text-white/90 drop-shadow-md">
              Join our community and experience seamless payments
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-20 xl:px-24">
        <div className="mx-auto w-full max-w-sm lg:w-96">
          ...
          <div className="mb-8 text-center lg:text-left">
            <h1 className="text-4xl font-bold text-gray-900">Payyed</h1>
            <p className="text-sm text-gray-600 mt-2">Secure Digital Payments</p>
          </div>

          {/* Header */}
          <div className="mb-8 text-center lg:text-left">
            <h2 className="text-3xl font-bold text-gray-900">Get Verified!</h2>
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200"
                />
              </div>
            </div>
